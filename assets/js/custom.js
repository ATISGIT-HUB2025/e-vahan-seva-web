...
(function ($) {
  ...
  var Impel = {
    ...
    /*-----------------------------------------------------
        ...
        -----------------------------------------------------*/
    type_slider: function () {
      new Swiper(".testiminials .swiper", {
        loop: true,
        speed: 800,
        autoplay: {
          delay: 2500,
